...
module.exports = function (config, files) {
  ...
  // regexp pattern for filename
  var pattern = new RegExp('\\.' + config.schemaSuffix.replace('.', '\\.') + '$', "i");
